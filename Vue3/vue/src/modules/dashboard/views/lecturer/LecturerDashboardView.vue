        ...
        <b-row class="p-0">
            ...
            <b-col class="col-lg-6">
                <b-row class="pt-4">
                    <b-col cols="12">
                        <h5 class="border-bottom py-2 d-flex justify-content-between">
                            <span  class="pl-1 font-weight-bold">Student Tasks</span>
...
import {NameWithId, userService} from "@/services/users/UserService";
...
export default class LecturerDashboardService extends Vue {
    ...
    async setLecturerStudents() {
        ...
        await userService.getLecturerStudents(userId)
            .then((r) => {
    ...
    async setStudentTasks(studentId: string) {
        ...
        await taskService.getStudentTasksForLecturer(studentId)
            .then((r) => {
                this.currentTasks = r
            })
